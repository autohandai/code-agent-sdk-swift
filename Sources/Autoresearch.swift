...
public enum AutohandCLIEvent: Sendable {
  ...
  case hookFileModified(HookFileModifiedEvent)
  case hookPrePrompt(HookPrePromptEvent)
  case hookPostResponse(HookPostResponseEvent)
  case hookSessionError(HookSessionErrorEvent)
  case hookStop(HookStopEvent)
  case hookSessionStart(HookSessionStartEvent)
  case hookSessionEnd(HookSessionEndEvent)
  case hookSubagentStop(HookSubagentStopEvent)
  case hookPermissionRequest(HookPermissionRequestEvent)
  case hookNotification(HookNotificationEvent)
  case hookContextCompacted(HookContextCompactedEvent)
  case hookContextOverflow(HookContextOverflowEvent)
  case hookContextWarning(HookContextWarningEvent)
  case hookContextCritical(HookContextCriticalEvent)
  case mcpInvocationRequest(MCPInvocationRequestEvent)
  case mcpToolsChanged(MCPToolsChangedEvent)
  case learnProgress(LearnProgressEvent)
  case notification(method: String, payload: [String: AnyCodable], timestamp: String?)
  case rawNotification(method: String, params: AnyCodable)
}
