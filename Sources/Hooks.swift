...
public enum HookEvent: String, Sendable, CaseIterable {
    ...
    case autoresearchStart = "autoresearch:start"
    case autoresearchPause = "autoresearch:pause"
    case autoresearchInit = "autoresearch:init"
    case autoresearchBefore = "autoresearch:before"
    case autoresearchRun = "autoresearch:run"
    case autoresearchAfter = "autoresearch:after"
    case autoresearchLog = "autoresearch:log"
    case autoresearchDecision = "autoresearch:decision"
    case autoresearchReplay = "autoresearch:replay"
    case autoresearchRescore = "autoresearch:rescore"
    case autoresearchPrune = "autoresearch:prune"
    case autoresearchComplete = "autoresearch:complete"
    case autoresearchError = "autoresearch:error"
    case preLearn = "pre-learn"
    case postLearn = "post-learn"
    case goalWrittenCompleted = "goal-written:completed"
